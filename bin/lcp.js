...
var optionDefinitions = [
  ...
  { name: 'headersToStrip', type: String, defaultValue: 'origin,referer' }
];
...
try {
  ...
  lcp.startProxy(options.port, options.proxyUrl, options.proxyPartial, options.credentials, options.origin, options.headersToStrip);
} catch (error) {
  console.error(error);
}
